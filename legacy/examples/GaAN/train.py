...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp_id", type=int, default=0, help="the id of experiment")
    parser.add_argument(
        "--epochs",
        type=int,
        default=100,
    ...
    parser.add_argument(
        "--lr", type=float, default=1e-2, help="learning rate of Adam")
    parser.add_argument(
        "--rc", type=float, default=0, help="regularization coefficient")
    parser.add_argument(
        "--log_path", type=str, default="./log", help="the path of log")
    parser.add_argument(
        "--batch_size",
        type=int,
        default=1024,
    ...
    print("lr = {}, rc = {}, epochs = {}, batch_size = {}".format(
        args.lr, args.rc, args.epochs, args.batch_size))
    ...
    g, label, train_idx, valid_idx, test_idx, evaluator = get_graph_data(
        d_name=d_name, mini_data=eval(args.mini_data))

    if args.model == "GaAN":
        graph_model = GaANModel(112, 3, args.hidden_size_a, args.hidden_size_v,
                                args.hidden_size_m, args.hidden_size_o,
                                args.heads)
    ...
    for epoch in range(args.epochs):
        ...
        print(
            ...
            format(epoch, train_loss, valid_loss, train_rocauc, valid_rocauc,
                   end_e - start_e))
        ...
        if valid_rocauc > best_valid:
            ...
            fluid.io.save_params(
                executor=exe,
                dirname='./params/' + str(args.exp_id),

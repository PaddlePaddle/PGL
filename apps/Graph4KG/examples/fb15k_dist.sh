...
# TransE
python -m paddle.distributed.launch --run_mode collective --gpus 0,1,2,3 dist_train.py --model_name TransE --data_name FB15k --data_path $DATA_PATH --save_path output/transe_fb_4gpu \
...
# DistMult
python -m paddle.distributed.launch --run_mode collective --selected_gpus 0,1,2,3 dist_train.py --model_name DistMult --data_name FB15k --data_path $DATA_PATH --save_path output/distmult_fb_4gpu \
...
# ComplEx
python -m paddle.distributed.launch --run_mode collective --selected_gpu 0,1,2,3 dist_train.py --model_name ComplEx --data_name FB15k --data_path $DATA_PATH --save_path output/complex_fb_4gpu \
...
# RotatE
python -m paddle.distributed.launch --run_mode collective --selected_gpu 0,1,2,3 dist_train.py --model_name RotatE --data_name FB15k --data_path $DATA_PATH --save_path output/rotate_fb_4gpu \
...
# OTE
python -m paddle.distributed.launch --run_mode collective --selected_gpu 0,1,2,3 dist_train.py --model_name OTE --data_name FB15k --data_path $DATA_PATH --save_path output/ote_fb_4gpu \
...
# TransE
python -m paddle.distributed.launch --run_mode collective --selected_gpu 0,1,2,3 dist_train.py --model_name TransE --data_name FB15k --data_path $DATA_PATH --save_path output/transe_fb_4mgpu \
...
# DistMult
python -m paddle.distributed.launch --run_mode collective --selected_gpu 0,1,2,3 dist_train.py --model_name DistMult --data_name FB15k --data_path $DATA_PATH --save_path output/distmult_fb_4mgpu \
...
# ComplEx
python -m paddle.distributed.launch --selected_gpu 0,1,2,3 dist_train.py --model_name ComplEx --data_name FB15k --data_path $DATA_PATH --save_path output/complex_fb_4mgpu \
--batch_size 1000 --log_interval 1000  --test_batch_size 16 --neg_sample_type 'chunk' --num_workers 2 \
--neg_sample_size 200 --embed_dim 400 --gamma 143.0 --lr 0.1 --optimizer adagrad --reg_coef 2e-6 \
--test -adv --max_steps 6000 --filter_eval --print_on_screen --mix_cpu_gpu --async_update

# RotatE
python -m paddle.distributed.launch --selected_gpu 0,1,2,3 dist_train.py --model_name RotatE --data_name FB15k --data_path $DATA_PATH --save_path output/rotate_fb_4mgpu \
...
# OTE
python -m paddle.distributed.launch --selected_gpu 0,1,2,3 dist_train.py --model_name OTE --data_name FB15k --data_path $DATA_PATH --save_path output/ote_fb_4mgpu \

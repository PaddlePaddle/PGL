...
--num_workers 4 --test --print_on_screen --async_update --mix_cpu_gpu --max_steps 250000 --mlp_lr 0.25 --mlp_optimizer Adagrad --valid --eval_interval 25000
...
--test -adv --num_epoch 50 --print_on_screen --async_update --mix_cpu_gpu --mlp_lr 0.1 --mlp_optimizer Adagrad
...
--num_workers 4 --num_epoch 50 --test --print_on_screen --neg_deg_sample --async_update --mix_cpu_gpu --mlp_lr 0.01 --mlp_optimizer Adagrad
...
--test -adv --num_epoch 50 --print_on_screen --reg_coef 2e-6 --reg_norm 3  --async_update --mix_cpu_gpu --mlp_lr 0.1 --mlp_optimizer Adagrad

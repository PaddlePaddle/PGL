...
--batch_size 512 --neg_sample_size 1024 --neg_sample_type 'chunk' --embed_dim 500 --gamma 6.0 -adv --mlp_lr 0.1 --mlp_optimizer Adagrad \
...
--batch_size 512 --neg_sample_type 'chunk' --num_workers 4 --neg_sample_size 1024 --embed_dim 1000 --gamma 200.0 --mlp_lr 0.1 --mlp_optimizer Adagrad \
...
--batch_size 512 --neg_sample_type 'chunk' --num_workers 4 --neg_sample_size 1024 --embed_dim 500 --gamma 200.0 --mlp_lr 0.1 --reg_coef 5e-6 --mlp_optimizer Adagrad \
...
--batch_size 512 --reg_coef 1e-7 --neg_sample_size 1024 --neg_sample_type 'chunk' --embed_dim 500 --gamma 6.0 --mlp_lr 0.0001 --mlp_optimizer Adam -adv -a 0.5 \
...
--num_workers 8 --max_steps 25000 --test --print_on_screen --ote_size 4 --ote_scale 2 --scheduler_interval 2500 --mlp_lr 0.0001 --mlp_optimizer Adam

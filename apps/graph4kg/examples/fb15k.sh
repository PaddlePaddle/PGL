...
--num_workers 8 --num_epoch 100 --valid --test --print_on_screen --async_update --mix_cpu_gpu --filter_eval
...
--num_workers 2 --num_epoch 50 --test --print_on_screen --ent_times 2 --filter_eval --neg_deg_sample

...
#                 edge_sg =  sg.maked_select(edge_type == i)
#                 feature = self.gats[idx](edge_sg, feature)
            
            feature = self.gats[idx](sg, feature)
            feature = paddle.gather(feature, sub_index, axis=0)
            
            feature = feature + skip_feat
            feature = F.elu(self.norms[idx](feature))

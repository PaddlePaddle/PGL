...
allowable_features = {
    ...
    #  'possible_hop': [0, 1, 2, 3, 4, 5, 6, 7, 8, 'misc'],
}
...
def get_atom_feature_dims():
    return list(
        map(len, [
            ...
            allowable_features['possible_in_num_ring_size_list'],
            allowable_features['possible_in_num_ring_size_list'],
            allowable_features['possible_in_num_ring_size_list'],
            allowable_features['possible_in_num_ring_size_list'],
            allowable_features['possible_in_num_ring_size_list'],
            allowable_features['possible_in_num_ring_size_list'],
            allowable_features['possible_valence_out_shell_list'],
        ]))
    ...
    bare_bond_feature_dims = list(
        map(
            ...
            [
                ...
                #  allowable_features['possible_hop']
            ]))
...
def atom_feature_vector_to_dict(atom_feature):
    [
        ...
        num_h_idx, number_radical_e_idx, hybridization_idx, is_aromatic_idx,
        is_in_ring_idx
    ] = atom_feature

    feature_dict = {
        'atomic_num':
        allowable_features['possible_atomic_num_list'][atomic_num_idx],
        'chirality':
        allowable_features['possible_chirality_list'][chirality_idx],
        'degree': allowable_features['possible_degree_list'][degree_idx],
        'formal_charge':
        allowable_features['possible_formal_charge_list'][formal_charge_idx],
        ...
        'hybridization':
        allowable_features['possible_hybridization_list'][hybridization_idx],
        'is_aromatic':
        allowable_features['possible_is_aromatic_list'][is_aromatic_idx],
        'is_in_ring':
        allowable_features['possible_is_in_ring_list'][is_in_ring_idx]
    }
...
def bond_feature_vector_to_dict(bond_feature):
    ...
    feature_dict = {
        'bond_type':
        allowable_features['possible_bond_type_list'][bond_type_idx],
        'bond_stereo':
        allowable_features['possible_bond_stereo_list'][bond_stereo_idx],
        'is_conjugated':
        allowable_features['possible_is_conjugated_list'][is_conjugated_idx]
    }

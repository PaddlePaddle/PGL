...
if args.data_name=="arxiv":
    dataset = PygNodePropPredDataset(name='ogbn-arxiv',root = '/data/mingguo_he/OGB/dataset/')
...
print(labels)
np.savez(data_path+"labels_"+args.data_name+".npz",tr_lb=labels_train,va_lb=labels_valid,te_lb=labels_test)
